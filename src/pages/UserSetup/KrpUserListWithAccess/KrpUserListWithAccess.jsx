...
const KrpUserListWithAccess = () => {
  ...
  const columnLayout = [
    ...
    {
      dataField: 'name',
      headerText: "No.of" + '<br>' + "Power" + '<br>' + "use",
      width: 140
    },
    {
...
export default KrpUserListWithAccess;
