...
import LineChart from "./PricesRateLineChart";
import InputNum from "../../../components/InputNum/InputNum";
import Select from "../../../components/Select/Select";
import Button from "../../../components/Button/Button";
import styles from "./pricesRate.module.scss";
...
const PricesRate = () => {
  ...
  const [levyPrice, setLevyPrice] = useState("");
  ...
  const selectGridData = async () => {
    ...
    try {
      ...
      fetch(
        ...
        .then((data) => {
          ...
          if (parseData.length > 6) {
            parseData = parseData.slice(0, 6); // 6개만 보여주기
          }
          grid.showAjaxLoader();
      ...
      console.error("Error fetching getPriceRate:", error);
    }
  };
